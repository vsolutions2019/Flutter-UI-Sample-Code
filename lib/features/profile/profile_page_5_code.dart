                ...
                Column(
                  children: <Widget>[
                    ListTile(
                      ...
                      subtitle: Text("email@gmailc.com",style: TextStyle(fontSize: 15,color: Colors.black54)),
                    ),
                    Divider(),
                    ListTile(
                      ...
                      subtitle: Text("11-111111-11",style: TextStyle(fontSize: 15,color: Colors.black54)),
                    ),
                    Divider(),
                    ListTile(
                    ...
                    ListTile(
                      ...
                      leading: Icon(Icons.my_location, color: Colors.deepOrangeAccent),
                      title: Text("Location",style: TextStyle(fontSize: 18,color: Colors.black)),
                      subtitle: Text("Canada",style: TextStyle(fontSize: 15,color: Colors.black54)),
                    ),
                  ],
                )
              ],
