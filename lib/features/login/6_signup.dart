...
class SignUpPage_6 extends StatefulWidget {
  static const routeName = '/SignUpPage_6';
  @override
  _SignUpPage_6State createState() => _SignUpPage_6State();
}

class _SignUpPage_6State extends State<SignUpPage_6> {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () {
              Navigator.of(context).pop(SignInScreen.routeName);
