...
class ResideMenuPage extends StatefulWidget {
  ...
  @override
  _ResideMenuPageState createState() => _ResideMenuPageState();
}
            ...
            child: Container(
              child: new ListView(
                ...
                children: <Widget>[
                  ...
                  getMaterialResideMenuItem('Message', EvilIcons.envelope, 3),
                  getMaterialResideMenuItem(
                      'Requests', SimpleLineIcons.envelope_letter, 4),
                  getMaterialResideMenuItem('Tickets', Foundation.ticket, 5),
                  getMaterialResideMenuItem(
                      'Account Settings', Feather.settings, 6),
