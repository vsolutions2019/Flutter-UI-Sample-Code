 ...
 /// ---------------------------
 /// Hidden Menu Drawer widget goes here.
 /// ---------------------------
class HiddenMenu extends StatefulWidget {
  static const routeName = '/HiddenMenu';
  _HiddenMenuDrawerPageState createState() => _HiddenMenuDrawerPageState();
}

class _HiddenMenuDrawerPageState extends State<HiddenMenu>
  ...
  Widget build(BuildContext context) {
    ...
    /// ---------------------------
    /// Building main content with hidden drawer .
    /// ---------------------------
